...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', lessonType: LessonType, id: string, slug: string, title: string, availableAt?: any | null }> };
